...
public final class simpleBean_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
    ...
    try {
      ...
      out.write("\n");
      out.write("\n");
      com.shamim.bean.Person person = null;
      synchronized (request) {
        person = (com.shamim.bean.Person) _jspx_page_context.getAttribute("person", PageContext.REQUEST_SCOPE);
        if (person == null){
          person = new com.shamim.bean.Person();
